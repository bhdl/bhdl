...
(define/IC (ATtiny25 ATtiny45 ATtiny85)
  ...
  #:top ([(vcc)])
  #:bottom ([(gnd)])
  #:left ([(pb0 mosi di sda ain0 oc0a oc1a aref pcint0)
...
(define/IC ATmega16
  ...
  #:right ([(PC0 SCL) (PC1 SDA) (PC2 TCK) (PC3 TMS) 
...
(define/IC ATmega128
  ...
  #:left ([(pa0 ad0) (pa1 ad1) (pa2 ad2) (pa3 ad3)
  ...
  #:right ([(pd0 scl int0) (pd1 sda int1) (pd2 rxd1 int2) (pd3 txd1 int3)
                           (pd4 icp1) (pd5 xck1) (pd6 t1) (pd7 t2)]
           [(pen) (pe0 rxd0 pdi) (pe1 txd0 pdo) (pe2 xck0 ain0) (pe3 oc3a ain1)
...
(define/IC (ATMEGA8U2
  ...
  #:left ([(PB0 SS PCINT0) (PB1 SCLK PCINT1) (PB2 PD1 MOSI PCINT2)
  ...
  #:right ([(PD0 OC0B INT0) (PD1 AIN0 INT1) (PD2 RXD1 AIN1 INT2) (PD3 TXD1 INT3)
  ...
  #:QFN (;; 1-8
         xtal1 xtal2 gnd vcc pc2 pd0 pd1 pd2
         ;; 9-16
